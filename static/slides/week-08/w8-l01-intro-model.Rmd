...
mercury <-
  ...
  mutate(sex,sex_cat=ifelse(sex==1,"Male","Female")) %>% # ifelse is alternative to case_when, sex_cat will be Male when sex==1 and Female otherwise
  mutate(native,native_cat=ifelse(native==1,"Native","Non-native"))  #native_cat will be "Native for native==1 and Non-native otherwise
```
