...
exam_dates <- c(ymd(20221019), ymd(20221207),ymd(20221216))

labonly_dates <- c(ymd(20220902),ymd(20220909),ymd(20220923),ymd(20221028),ymd(20221104))

labhw_dates <- c(ymd(20220916),ymd(20221007),ymd(20221111),ymd(20221202))

project_dates <- c(ymd(20221014,20221209))

labproject_dates <- c(ymd(20220930, 20221118))
