...
#author: "[Website](https://sta-198-glhlth-298-fall-2022.github.io/website/)"
...
Go to the [GitHub website at https://github.com/join](github.com/join) to create an account, and log your name and username on paper at the front of the room.  

When choosing a username, bear in mind that you may in the future wish to share your code with potential employers, so you want it to be something you're comfortable sharing with a future boss (e.g., think twice before making your username political or a paean to your favorite Ben & Jerry's flavor). Think about making it timeless (e.g., avoiding Duke or your current location) and easy to remember or for people to find (names are nice, and fine to re-use your username from other social media if it makes sense professionally). My user name is amy-herring.
...
.larger[
.center[
[**Course Website**](https://sta-198-glhlth-298-fall-2022.github.io/website/)
]
