...
2. We would like to test whether the proportions who believe smoking causes serious illness are the same among men and women using a Central Limit Theorem based test. First, determine whether the "rule of thumb" criteria ($np>10$ and $n(1-p)>10$) for validity of this test are satisfied. If these criteria are satisfied, carry out the test, and then report and interpret the test result.
