...
## Recap: Multiple regression model
...
The t-statistics provided are calculated by taking $\frac{\text{estimate}-0}{\text{std.error}}$. For the intercept this is often not meaningful, for parameter effects we are testing $H_0: \beta=0$ against $H_A: \beta \neq 0$. Here we use a t-interval, and R can calculate this for us upon request. The degrees of freedom here is the sample size minus the total number of regression coefficients (predictors+intercept) in the model.
...
$$\widehat{lhairhg}_i = 0.249 - 0.258 \times {assets\_sc}_i  - 0.126 \times {form\_min\_sc}_i$$
...
$$\widehat{lhairhg}_i = 1.00 - 0.0945 \times assets\_sc_i - 0.957 \times I(nonnative_i=1)$$
...
$$\widehat{lhairhg}_i = 1.00 - 0.0945 \times assets\_sc_i - 0.957  \times 0 = 1.00 - 0.0945 \times assets\_sc_i$$


--
- Non-native community: Plug in 1 for `native_cat`

$$\widehat{lhairhg}_i = 1.00 - 0.0945 \times assets\_sc_i - 0.957 = 0.043 - 0.0945 \times assets\_sc_i$$
...
$$\widehat{lhairhg}_i = 0.779 - 0.320 \times assetssc_i $$
...
$$\widehat{lhairhg}_i = 0.779 - 0.320 \times assetssc_i - 0.757 \times 0 + 0.301 \times assetssc_i \times 0 $$
$$\widehat{lhairhg}_i = 0.779 - 0.320 \times assetssc_i$$

- Non-native community resident: 
$$\widehat{lhairhg}_i = 0.779 - 0.320 \times assetssc_i - 0.757 \times 1 + 0.301 \times assetssc_i \times 1$$

$$\widehat{lhairhg}_i = 0.022 - 0.019 \times assetssc_i$$
