...
First, we should call the libraries that house the data. Because the `coronavirus` package is updated daily, we should re-install it to get the most up to date data if we want to re-create plots in the future.
