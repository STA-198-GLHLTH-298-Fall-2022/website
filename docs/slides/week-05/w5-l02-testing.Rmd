...
-- Understand Null Hypothesis Significance Testing framework and its limitations
...
- Figure out how likely it is to see data like what we got, or even more surprising data,  if claim 1 is true.

- If such data would have been unlikely if claim 1 were true, then we reject claim 1 and deem claim 2 worthy of further study.  Otherwise, we cannot reject claim 1.

---

### Example: Ultra Low Dose Contraceptives

A certain ultra-low dose oral contraceptive pill is supposed to contain 0.02 mg (20 $\mu$g) of estrogen. If the dose is higher, the user may risk side effects better avoided (e.g., headaches or fluid retention), and if the dose is lower, the user may get pregnant.  The manufacturer wishes to check whether the mean concentration in a large shipment is the needed 0.02 mg or not.  A random sample of n=50 pills is tested, and the sample mean concentration is 0.017 mg with a sample standard deviation of 0.008 mg.
...
3. The WHO would like to know if the prevalence of monkeypox in non-endemic countries this month is the same as last month.
...
### P-values and Odds the Hypothesis is True

```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("img/probablecause.jpg")
```
